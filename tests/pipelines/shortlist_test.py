...
from src.pipelines.shortlist import cli
...
def test_run_exits_cleanly(runner: CliRunner, mocker: MockerFixture) -> None:
    mocker.patch("src.pipelines.shortlist.make_sheets_client")
...
def test_dry_run_uses_test_sheet(runner: CliRunner, mocker: MockerFixture) -> None:
    mocker.patch("src.pipelines.shortlist.get_settings")
    factory = mocker.patch("src.pipelines.shortlist.make_sheets_client")
